...
public class HomeActivityBackup extends AppCompatActivity {
    ...
    private Context mContext = HomeActivityBackup.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationUpdateReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (HomeActivityBackup.this.locationService.isLogging) {
                    addPolyline();
                }
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HomeActivityBackup.this.locationService.startLogging();
        ...
        stopButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HomeActivityBackup.this.locationService.stopLogging();
                stop();
            }
        });
        // end new
    ...
    private void runMap() {
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                if (ActivityCompat.checkSelfPermission(HomeActivityBackup.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(HomeActivityBackup.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
    ...
    private void getDeviceLocation(){
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(HomeActivityBackup.this);
                try{
                    if(mLocationPermissionsGranted){
                        ...
                        location1.addOnCompleteListener(new OnCompleteListener() {
                            ...
                            public void onComplete(@NonNull Task task) {
                                if(task.isSuccessful()){
                                    ...
                                    Toast.makeText(HomeActivityBackup.this, "New Posistion " + latLng, Toast.LENGTH_SHORT).show();
                                }else{
                                    Log.d(TAG, "onComplete: current location is null");
                                    Toast.makeText(HomeActivityBackup.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
            ...
            public void onStatusChanged(String provider, int status, Bundle extras) {
                Toast.makeText(HomeActivityBackup.this, "New Posistion " , Toast.LENGTH_SHORT).show();
            }
    ...
    private void drawUserPositionMarker(Location location){
        ...
        if(this.userPositionMarkerBitmapDescriptor == null){
            userPositionMarkerBitmapDescriptor = BitmapDescriptorFactory.fromResource(R.drawable.user_position_point2);
        }
    ...
    private void drawPredictionRange(Location location){
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                HomeActivityBackup.this.predictionRange.setVisible(false);
            }
        }, 2000);
    }
